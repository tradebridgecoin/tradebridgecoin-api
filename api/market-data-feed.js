...
class MarketData {
    ...
    isInTradingHours(category) {
        switch (category) {
            case 1:
                return this.ashares.isInTradingHours();
            case 2:
                return this.fx.isInTradingHours();
            case 3:
                return this.ivx.isInTradingHours();
            case 4:
                return this.crypto.isInTradingHours()
        }
    }
}
